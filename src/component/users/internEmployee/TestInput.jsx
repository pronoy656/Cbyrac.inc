...
// <div>
// <label className="text-white">High School / College</label>
...
// <div>
// <label className="text-white">Study / Major</label>
// <div className={inputWrapperClass}>
// <input
// type="text"
...
// <div className={inputWrapperClass + " mb-6"}>
// <textarea
...
// <button
// type="submit"
// className="w-full bg-[#8D6851] hover:bg-[#7a5540] text-white font-semibold py-2 rounded-lg transition-colors"
// >
// Submit
// </button>
// </form>
